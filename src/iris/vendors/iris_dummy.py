...
import logging
from iris.constants import EMAIL_SUPPORT, IM_SUPPORT, CALL_SUPPORT, SMS_SUPPORT, SLACK_SUPPORT, PUSHOVER_SUPPORT

logger = logging.getLogger(__name__)


class iris_dummy(object):
    supports = frozenset([EMAIL_SUPPORT, IM_SUPPORT, CALL_SUPPORT, SMS_SUPPORT, SLACK_SUPPORT, PUSHOVER_SUPPORT])
